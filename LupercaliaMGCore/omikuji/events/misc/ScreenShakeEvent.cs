...
public class ScreenShakeEvent(Omikuji omikuji, LupercaliaMGCore plugin) : OmikujiEventBase(omikuji, plugin)
{
    ...
    public override void Execute(CCSPlayerController client)
    {
        ...
        Server.PrintToChatAll($"{Omikuji.ChatPrefix} {Plugin.Localizer["Omikuji.MiscEvent.ScreenShakeEvent.Notification.PrepareForImpact", client.PlayerName]}");
